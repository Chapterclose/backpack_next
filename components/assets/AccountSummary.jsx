  ...
  return (
    <div>
      <div className="flex items-center gap-x-5">
        <h4 className="text-xl lg:text-4xl font-semibold text-black dark:text-white">
      ...
      <div className="flex items-center text-center gap-x-5 mt-10">
        ...
        >
          ...
          <h4 className="text-[14px] md:text-base font-medium dark:text-white text-black mt-1">
            Deposit
          </h4>
        </Link>
        <Link
