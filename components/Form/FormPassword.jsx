    ...
    return ( 
        <div>
            ...
            <div className="relative">
                <input type={isEye ? "text" :"password"} placeholder={placeholder} className={twMerge("w-full h-10 rounded border border-gray-900 dark:border-white focus:outline-none pl-4 dark:placeholder:text-white", className)} />
