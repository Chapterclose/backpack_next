...
function Withdraw() {
    return ( 
        <div className="container py-[80px]">
            <h4 className="text-4xl font-semibold text-black mb-8 text-center">Withdrawal</h4>
                ...
                <ul>
                    {
                        currenciesListArr?.map((item,)=>(
                            <Link href={`/withdraw-apply?coin=${item.title}`} className="flex items-center justify-between hover:bg-gray-100 px-3 rounded">
